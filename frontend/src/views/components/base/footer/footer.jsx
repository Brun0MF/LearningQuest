...
export default function Footer() {
    return (
        <footer className="bg-verdeSuave-300">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-20 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-500 font-medium">
                                ...
                                <li className="mb-4">
                                    <a href="https://tailwindcss.com/" className="hover:underline">Cursos</a>
                                </li>
                                <li className="mb-4">
                                    <a href="https://tailwindcss.com/" className="hover:underline">Rankings</a>
                                </li>
                                <li>
                                    <a href="https://tailwindcss.com/" className="hover:underline">Definições</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase">Segue-nos</h2>
                            <ul className="text-gray-500 font-medium">
                                <li className="mb-4">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center">© 2025 <a href="https://learningquest.com/" className="hover:underline">LearningQuest™</a>. All Rights Reserved.
                    </span>
