  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="absolute right-2 mt-[8px] flex w-[260px] flex-col rounded-tr-none rounded-b-3xl border border-gray-200 bg-white p-3 shadow-theme-lg"
      >
        <div className="mb-3">
        ...
        >
          <svg
            className="fill-red-600 group-hover:fill-red-600"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="none"
