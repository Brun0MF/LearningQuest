...
const FiltrosHome = ({categorias = [], categoriaId = "", onChangeCategoria}) => {
    ...
    return(
        <div className="flex flex-row gap-3 items-center">
            ...
            <select onChange={onChangeCategoria} value={categoriaId} id="" className="w-6/12 rounded-xl border border-verdeSuave-600 px-2 py-1 focus:border-verdeSuave focus:ring-2 focus:ring-verdeSuave outline-none transition-all">
