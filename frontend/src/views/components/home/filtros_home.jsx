...
const FiltrosHome = () => {
    ...
    return(
        <div className="flex flex-row justify-between">
            <select name="" id="" className="w-5/12 rounded-xl border border-verdeSuave-600 px-2 focus:border-verdeSuave focus:ring-2 focus:ring-verdeSuave outline-none transition-all">
