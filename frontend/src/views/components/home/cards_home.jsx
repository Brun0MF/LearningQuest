        ...
        <div className="flex flex-col gap-4 p-2 w-full rounded-xl border border-verdeSuave-600 bg-verdeSuave-50">
            <div className="flex flex-row justify-between items-center p-2">
                ...
                <div className="flex flex-col items-center justify-center">
                    ...
                    <button className="bg-verdeSuave-600 font-medium text-white py-2 px-5 rounded-xl hover:bg-verdeSuave-500">
                        Jogar
                    </button>    
                </div>
            ...
            <div className="flex flex-row gap-3">
                {frutas.map((fruta, index) => {
                    ...
                    if(index === 0) {
                        ...
                        cor = 'border-amber-600 bg-gradient-to-b from-amber-200 to-amber-100 text-amber-800 shadow-md';
                        corMedalha = 'text-amber-600';
                    }
                    else {
