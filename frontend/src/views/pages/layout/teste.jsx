...
const Teste = () => {
    ...
    return (
        <>
            ...
            <nav className="fixed top-0 z-50 w-full bg-white border-b border-verdeSuave">
                <div className="px-3 py-3 lg:px-5 lg:pl-3">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center justify-start rtl:justify-end">
                            <button onClick={() => setOpen(v => !v)} data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" className="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
                            ...
                            <a href="https://flowbite.com" className="flex ms-2 md:me-24">
                                <img src='/LQ.png' className="h-8 me-3" alt="FlowBite Logo" />
                            </a>
                        </div>
            ...
            <aside
                id="logo-sidebar"
                className={`fixed top-0 left-0 z-40 h-screen pt-20 bg-white border-r border-verdeSuave
  ...
  `}
            ...
            >
                <div className="h-full flex flex-col justify-between px-3 pb-4 overflow-y-auto bg-white">
                    ...
                    {/* BOTÃO SIGN OUT EM BAIXO */}
                    <div className="border-t border-verdeSuave  pt-3 mt-3">
                        <a
                            href="#"
                            className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 group"
                        >
